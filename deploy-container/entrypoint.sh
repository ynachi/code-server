...
mkdir -p $START_DIR/.code-server/extensions $START_DIR/algs4

# Setup princeton java library
curl -o $START_DIR/algs4/algs4.jar https://algs4.cs.princeton.edu/code/algs4.jar
curl -o $START_DIR/algs4/algs4-data.zip https://algs4.cs.princeton.edu/code/algs4-data.zip
...
--user-data-dir $START_DIR/.code-server \
--extensions-dir $START_DIR/.code-server/extensions --auth none $START_DIR
